<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"F:\www\Tp_try\think\public/../application/admin\view\article\edit.html";i:1507814050;s:69:"F:\www\Tp_try\think\public/../application/admin\view\common\left.html";i:1507803994;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">所属类别</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">简介</label>
                            <div class="col-sm-6">
